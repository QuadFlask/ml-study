...
network = Net(input_size=12, hidden_size=864, hidden_size_2=288, output_size=3)
...
for i in range(30000):
    ...
    if i % 1000 == 0:
        ...
        if train_loss < 3:
            learning_rate = 0.025 / 2

            if train_loss < 2:
                learning_rate = 0.025 / 4
        ...
        print(str(i) +
              ...
              # ' \nf1inter: ' + str(f1inter(test_label[0][1], test_label[0][2])) +
              ' \ntest f(x): ' + str(test_label[1][0]) + ' x^2 + ' + str(test_label[1][1]) + ' x + ' + str(test_label[1][2]) +
              # ' \nf2inter: ' + str(f2inter(test_label[0][1], test_label[0][2], test_label[1][2])) +
